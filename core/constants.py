...
YOM = 'YOM'
CSV_HEADERS = {MAKE, TYPE, ASSET_CODE, CATEGORY, SUB_CATEGORY, MODEL_NUMBER, SERIAL_NUMBER, ASSIGNED_TO,
               STATUS, ASSET_MEMORY, VERIFIED, NOTES, STORAGE, ASSET_PROCESSOR_TYPE, YOM, }
